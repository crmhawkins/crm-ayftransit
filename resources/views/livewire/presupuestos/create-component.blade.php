                    ...
                    <div class="form-row">
                        @if ($id_cliente != 0 || $id_cliente != null)
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="example-text-input" class="col-sm-12 col-form-label"
                                        disabled>Dirección</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $clienteSeleccionado->direccion }}"
                                            class="form-control" name="direccion" placeholder="Dirección" disabled>
                                        @error('direccion')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <!-- Tipo de Calle -->
                                <div class="form-group col-md-6">
                                    <label for="example-text-input" class="col-sm-12 col-form-label" disabled>Email</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $clienteSeleccionado->email }}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $clienteSeleccionado->telefono }}"
                                            class="form-control" name="telefono" placeholder="XXXXXXXXX" disabled>
                                        @error('telefono')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group mb-1">
                                ...
                                <div class="col-md-8" x-data="" x-init="$('#select2-proveedor').select2();
                                $('#select2-proveedor').on('change', function(e) {
                                    var data = $('#select2-proveedor').select2('val');
                                    @this.set('id_proveedor', data);
                                });"
                                    wire:key='rand()'>
                                    <select class="form-control" name="id_proveedor" id="select2-proveedor"
